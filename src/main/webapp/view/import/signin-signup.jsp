		...
		<div class="signin">
			...
			<div class="right">
				<div class="popup-header">
					<img src="<%=request.getContextPath()%>/images/logo.jpg" alt="popup logo" class="popup-header__img"/>
				...
				<div class="other-way-signin">
					<a href="?fb" class="btn-signin signin-fb">
						<img src="<%=request.getContextPath()%>/images/fb.png" alt="facebook sign in" class="signin-img"/>
						<span class="signin-title">Facebook</span>
					</a>
					<a href="?gg" class="btn-signin signin-gg">
						<img src="<%=request.getContextPath()%>/images/gg.png" alt="facebook sign in" class="signin-img img-gg"/>
