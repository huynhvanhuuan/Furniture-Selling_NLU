...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css" 
          integrity="sha512-PgQMlq+nqFLV4ylk1gwUOgm6CtIIXkKwaIHp/PAIWHzig/lKZSEGKEysh0TCVbHJXCLN7WetD8TFecIky75ZfQ==" crossorigin="anonymous" referrerpolicy="anonymous"/>
        ...
        <div class="introduce">
            <div class="title">
                <div class="title-left">
                    ...
                    <p class="p2">
                        Chúng tôi mang đến những giải pháp nội thất tối giản với độ ứng dụng cao, phù hợp với nhiều phong cách khác nhau, tạo ra không
        ...
        <div class="collections">
            ...
            <div class="col-list">
                <div class="col-item">
                    <div class="item">
                        <div class="image">
                            <img src="<%=request.getContextPath()%>/images/main/col1.jpg" alt="" />
                        </div>
                        <p></p>
                    </div>
                </div>
                <div class="col-item">
                    <div class="item">
                        <div class="image">
                            <img src="<%=request.getContextPath()%>/images/main/col2.jpg" alt="" />
                        </div>
                        <p></p>
                    </div>
                </div>
                <div class="col-item">
                    <div class="item">
                        <div class="image">
                            <img src="<%=request.getContextPath()%>/images/main/col3.jpg" alt="" />
                        </div>
                        <p></p>
                    </div>
                </div>
                <div class="col-item">
                    <div class="item">
                        <div class="image">
                            <img src="<%=request.getContextPath()%>/images/main/col4.jpg" alt="" />
                        </div>
                        <p></p>
                    </div>
                </div>
                <div class="col-item">
                    <div class="item">
                        <div class="image">
                            <img src="<%=request.getContextPath()%>/images/main/col5.jpg" alt="" />
                        </div>
                        <p></p>
                    </div>
                </div>
